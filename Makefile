...
all: ./tests/test_singly_linked_list ./tests/test_doubly_linked_list ./tests/test_linked_list_stack ./tests/test_array_stack ./tests/test_linked_list_queue ./tests/test_bst ./tests/test_avl ./tests/test_red_black ./tests/test_max_heap ./tests/test_hash_table
...
./tests/test_hash_table: ./src/hash_table.o ./tests/test_hash_table.o

clean:
	rm ./src/*.o ./tests/*.o ./tests/test_singly_linked_list ./tests/test_doubly_linked_list ./tests/test_linked_list_stack ./tests/test_array_stack ./tests/test_linked_list_queue ./tests/test_bst ./tests/test_avl ./tests/test_red_black ./tests/test_max_heap ./tests/test_hash_table